...
- PostgreSQL storage
- 3D Mini App на React Three Fiber с сценой из Blender (`gol_v2.glb`; при отсутствии файла сервер отдаёт `gol_v1.glb`)
...
- Файл сцены: `gol_v2.glb` в корне (`GET /miniapp-3d/gol_v2.glb`; если файла нет — отдаётся `gol_v1.glb`).
