 ...
 *
 * В сцене GLB (`gol_v1.glb`) основная проходная точка полка→проектор задаётся объектом **Cam_temp**
 * в GLB (камера использует её как контрольную точку квадратичной Безье). Этот файл —
 * альтернатива, если нужна кривая Catmull–Rom без правки Blender.
 *
